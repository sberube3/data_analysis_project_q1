...
ANOVA_DL_2<- glm(formula=anovadl$ANOVA~(anovadl$dateplot+anovadl$DeepLearning+
                      anovadl$DeepLearning*anovadl$dateplot),
                 family=quasipoisson)
summary(ANOVA_DL_2)
...
anovaml_up<- anovaml[128:161,]

anovaml_down<- anovaml[1:127,]

difference_test_anova<- glm(anovaml_up$ANOVA~anovaml_up$dateplot,family=quasipoisson)
summary(difference_test_anova)


difference_test_2<- glm(anovaml_up$ANOVA~anovaml_up$dateplot+anovaml_up$MachineLearning,family=quasipoisson)
summary(difference_test_2)


difference_test_1_anova<-  glm(anovaml_down$ANOVA~anovaml_down$dateplot,family=quasipoisson)
summary(difference_test_1_anova)


difference_test_2_anova<-  glm(anovaml_down$ANOVA~anovaml_down$dateplot+anovaml_down$MachineLearning,family=quasipoisson)
summary(difference_test_2_anova)


##################################


difference_test_ML<- glm(anovaml_up$MachineLearning~anovaml_up$dateplot,family=quasipoisson)
summary(difference_test_ML)


difference_test_ML_1<- glm(anovaml_down$MachineLearning~anovaml_down$dateplot,family=quasipoisson)
summary(difference_test_ML_1)

difference_test_ML_joint<-  glm(anovaml_down$MachineLearning~anovaml_down$dateplot+anovaml_down$ANOVA,family=quasipoisson)
summary(difference_test_ML_joint)

difference_test_ML_joint_1<-  glm(anovaml_up$MachineLearning~anovaml_up$dateplot+anovaml_up$ANOVA,family=quasipoisson)
summary(difference_test_ML_joint_1)
```
